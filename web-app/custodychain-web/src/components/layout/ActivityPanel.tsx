...
export default function ActivityPanel() {
  ...
  return (
    <div className="relative overflow-hidden h-full rounded-md bg-orange-50 border-2 border-orange-700">
      {/* title */}
      <div className="z-99 absolute top-0 right-0 left-0 p-3 backdrop-blur-xs bg-orange-50/60 rounded-t-sm font-sans font-[500] text-2xl text-orange-700 border-b-2 border-orange-700">
        Activity:
      </div>
      <div
        ref={scrollContainerRef}
        className="overflow-y-scroll h-full pt-[65px] p-3"
      >
        {!account ? (
